...
class UrTube:
    ...
    def watch_video(self, search_word):
        my_video = None
        ...
        for video in self.videos:
            if search_word.lower() == video.title.lower():
                my_video = video
                break
        ...
        if my_video.adult_mode and self.current_user.age < 18:
            print("Вам нет 18 лет, пожалуйста покиньте страницу.")
            return

        print(f"Воспроизведение видео '{my_video.title}' началось.")
